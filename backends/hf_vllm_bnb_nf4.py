"""
backends/hf_vllm_awq.py
------------------------
vLLM inference backend with on-the-fly INT4 NF4 quantization via bitsandbytes,
"""
...
# ---------------------------------------------------------------------------
# Everything below is identical to hf_vllm.py
# ---------------------------------------------------------------------------
...
async def run_vllm_bnb_nf4(cfg: ExperimentConfig) -> ExperimentResult:
    torch.cuda.reset_peak_memory_stats(cfg.device)

    print(f"[{BACKEND_NAME}] Starting AsyncLLMEngine (bitsandbytes NF4 + prefix_caching=True) ...")
